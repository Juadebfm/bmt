...
const MultiServices = () => {
  return (
    <section className="h-[70vh] flex items-center justify-center px-10 gap-16 mt-10">
      <div className="w-1/2 flex flex-col justify-center">
        <h2 className="w-full text-[44px] leading-[1.2] capitalize font-[600] text-primary_red">Our Multi-disciplinary services</h2>
        <p className="w-[85%] text-[18px] leading-normal mt-10">
