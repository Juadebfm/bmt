...
const MultiServices = () => {
  ...
  return (
    <section
      data-aos="fade-up"
      className="h-auto lg:h-[70vh] flex flex-col-reverse lg:flex-row items-center justify-center px-[25px] sm:px-16 gap-10 sm:gap-20 mt-14 mb-24 scroll_item"
    >
      <div className="w-full md:w-full lg:w-1/2 flex flex-col justify-center">
        ...
        <p className="text-[19px] text-center lg:text-start leading-normal mt-6">
