  ...
  return (
    ...
    >
      <div className="w-full lg:w-1/2 flex flex-col justify-center">
        <h2 className="w-full text-[34px] lg:text-[44px] leading-[1.2] text-center lg:text-start mt-7 lg:mt-0 capitalize font-[600] text-primary_red">
          Understanding stem cell transplantation
          <span className="text-[22px] font-normal ml-2 block">
            (Bone marrow transplantation)
          </span>
        </h2>
        <p className="w-[95%] text-[18px] md:text-[20px] leading-normal mt-8 text-center lg:text-start">
